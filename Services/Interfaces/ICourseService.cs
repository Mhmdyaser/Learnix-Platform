...
namespace Learnix.Services.Interfaces
{
    public interface ICourseService : IGenericService<Course, CourseDto,int>
    {
        ...
        public  Task<(bool Success, string Reason)> EnrollInCourse(int courseId, string studentId);
        ...
        Task<IEnumerable<CourseListViewModel>> GetPopularCoursesAsync(int count = 6);
